...
async function testLandsOfAmerica() {
  console.log("Testing Lands of America plugin...\n")
  ...
  try {
    for await (const property of landsofamericaPlugin.search(criteria, {
...
testLandsOfAmerica().catch(console.error)
